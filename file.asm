...
label2  BYTE    cr, Lf, "The difference is "
diff    BYTE    11 DUP (?)
        BYTE    cr, Lf, 0

label3  BYTE    cr, Lf, "The product is "
prod    BYTE    11 DUP (?)
        BYTE    cr, Lf, 0

label4  BYTE    cr, Lf, "The quotient is "
quo     BYTE    11 DUP (?)
        BYTE    cr, Lf, 0

label5  BYTE    cr, Lf, "The remainder is "
rem     BYTE    11 DUP (?)
        BYTE    cr, Lf, 0
